...
fun main() {
    println(unsetBbitsFromTheRight(25, 3))
}

fun unsetBbitsFromTheRight(A: Long, B: Int): Long {
    val mask = ((1 shl B) - 1).toLong().inv()
    return mask and A
}
//fun solve(A: Long, B: Int): Long? {
//    var ans = A
//    for (i in 0 until B) {
//        if (ans and (1 shl i).toLong() > 0) {
//            ans = ans xor (1 shl i).toLong()
//        }
//    }
//    return ans
//}